...
print(c.index(5, 2))#Esse número após o 5 é a partir de onde voce quer comecar a contar seu index: Nesse caso, começo a procurar um número 5 apenas após a posição 2!
